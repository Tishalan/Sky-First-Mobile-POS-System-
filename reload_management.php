...
// Fetch purchases and calculate total balances
...
if ($providers_result->num_rows > 0) {
    while ($prov = $providers_result->fetch_assoc()) {
        ...
        $providers_with_balance[$prov_id] = $prov;
    }
    $providers_result->data_seek(0); // Reset pointer
}
?>
...
<head>
    ...
    <title>Reload Management - SKY FIRST MOBILE Billing</title>
...
<body>
    ...
    <div class="nav">
            ...
            <a href="reload_management.php"class="active"><i class="fas fa-sim-card"></i> Reload Management</a>
    ...
    <div class="section">
        <h2><i class="fas fa-sim-card"></i> Manage Providers</h2>
        ...
        <table class="report-table">
            ...
            <tbody>
                <?php 
                // Reset pointer and loop through providers with their balances
                $providers_result->data_seek(0);
                while ($prov = $providers_result->fetch_assoc()): 
                    $total_balance = isset($providers_with_balance[$prov['id']]) ? $providers_with_balance[$prov['id']]['total_balance'] : 0;
                ?>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <form method="post" onsubmit="return confirm('Are you sure you want to delete this purchase?');">
                            ...
                            <button type="submit" name="delete_purchase" class="btn btn-danger"><i class="fas fa-trash"></i> Delete</button>
                        </form>
                    </td>
                </tr>
                <?php endwhile; ?>
